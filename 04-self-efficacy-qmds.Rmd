# Self-Efficacy and Quality Mountain Days {#self-efficacy-qmds}
...
Self-efficacy is domain-specific. Therefore, it is important that any measure of self-efficacy is also domain-specific [@Bandura2006]. There is no existing measure of Mountain Leader self-efficacy, however, in Chapter 3 we developed 11 self-efficacy items for skills that candidates would be required to perform at an assessment based on the Mountain Leader candidate handbook and syllabus [@MTUK2015a], and a separate skills checklist [@MTUK2015]. Therefore, the aim of Study 5 was to develop self-efficacy measure using these 11 items and provide initial evidence for its validity.


### Methods {#study-5-methods}

#### Participants. {#study-5-participants}

```{r chap4-study-5-participants, include = FALSE}
Group1to4 %>% 
...
Participants for Study 6 were a new sample of `r efficacy_s2_participants$n` candidates who had attended a Mountain Leader training course in 2017 or 2018 and completed the survey used for Chapter \@ref(ml-pra) (`r efficacy_s2_participants$female`% female, $M_{age}$ `r efficacy_s2_participants$m_age` years, $SD =$ `r efficacy_s2_participants$sd_age`, `r efficacy_s2_participants$assessed`% had been assessed when completing the survey).
...
## Applied Implications {#self-efficacy-applied-implications}
