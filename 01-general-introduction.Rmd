...
`r colorize("Candidates engage with the Mountain Leader qualification for different reasons. Therefore, in trying to understand why some candidates complete the Mountain Leader qualification and others do not, it is important to consider these reasons and the associated motivation. Further, it is widely accepted that a raft of factors will influence motivation","blue")` [@Deci2000; @Weinberg2014], `r colorize("these factors include both individual characteristics (e.g., personality, individual goals) and situational factors (e.g., interaction with others, the context of the behaviour); understanding candidates’ individual characteristics and situations is, therefore, important when trying to understand the effects of motivation on candidates likelihood of completing the Mountain Leader qualification.","blue")`

`r colorize("In this thesis I use self-determination theory","blue")` [@Deci1985b; @Deci2000; @Ryan2017] `r colorize("to consider motivation its relationship with both candidates' individual characteristics and situational factors. Self-determination theory is a theory of human behaviour that is widely used when studying motivation","blue")` [cf. @Ryan2019] `r colorize("and grew from studies of","blue")` *intrinsic motivation* [e.g., @Deci1975; @Deci1980a]. Intrinsically motivated behaviours are "behaviours that are motivated by the underlying need for competence and self-determination .... that are performed in the absence of any apparent external contingency" [@Deci1980a, p 42].
