...
\setlength{\parskip}{0em}%set paragtaph spacing to 0
...
The MLSS measures two factors: self-efficacy to perform routine skills and self-efficacy to perform emergency skills. Measurement invariance analyses suggested that the MLSS measured the same factors in female and male candidates, however there was evidence in \href{study-6}{Study 6} that female and male candidates has different scores on the factors, although the factor structure and item-factor loadings were no different between genders. In \href{study-6}{Study 6}, the results of moderated hierarchical regression analyses suggested that female candidates were less confident than male candidates, candidates with more experience were more confident, and the relationship between experience and routine skill self-efficacy was stronger for female candidates than it was for male candidates.
