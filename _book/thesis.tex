...
We also examined the pass rates for the Mountain Leader qualification. The pass rate \textcolor{black}{increased} over time, and there \textcolor{black}{were} changes in pass rates over the last 10 years for female and male candidates (Figure \ref{fig:PassRate}). When looking at pass rates for the last 10 years, female candidates are less likely to pass their first assessment, but the pass rate \textcolor{black}{increased} faster for them than it \textcolor{black}{did} for male candidates. However, when looking at data from the last five years, neither the effect of gender on the pass rate or rate of change of the pass rate is statistically significant.
...
Mountain Training wanted to understand why more people do not complete the Mountain Leader qualification and identify if there \textcolor{black}{are} any changes that they could make to the pathway that would better support their candidates. It is unlikely that there is a single factor that would be a ``silver bullet'' to improve completion rates. Instead, there is likely a myriad of factors which influence completion at various stages of the pathway. Some of these factors will be generic to all candidates, whilst some may be specific to individual \textcolor{black}{and/or groups of} candidates.
...
In line with the studies mentioned above, in this thesis, I took a holistic approach in understanding the factors that influence the completion rate of the Mountain Leader qualification, where we explored many factors using a variety of analytical methods. The work in the present thesis considers a wide range of factors. Providing a detailed literature review of \textcolor{black}{factor} each is beyond the scope of the present thesis, given the number of constructs included. However, in the following section, I aim to provide a brief overview of relevant theory and explain its relevance to the Mountain Leader qualification. Empirical chapters include additional detail where relevant. Further, these theories provide useful frameworks for discussing the results of the empirical chapters. These theories are useful for understanding the relationships between various factors, but this thesis is not a test of any specific theory.
...
\textcolor{black}{Candidates engage with the Mountain Leader qualification for different reasons. Therefore, in trying to understand why some candidates complete the Mountain Leader qualification and others do not, it is important to consider these reasons and the associated motivation. Further, it is widely accepted that a raft of factors will influence motivation} \citep{Deci2000, Weinberg2014}, \textcolor{black}{these factors include both individual characteristics (e.g., personality, individual goals) and situational factors (e.g., interaction with others, the context of the behaviour); understanding candidates’ individual characteristics and situations is, therefore, important when trying to understand the effects of motivation on candidates likelihood of completing the Mountain Leader qualification.}

\textcolor{black}{In this thesis I use self-determination theory} \citep{Deci1985b, Deci2000, Ryan2017} \textcolor{black}{to consider motivation its relationship with both candidates' individual characteristics and situational factors. Self-determination theory is a theory of human behaviour that is widely used when studying motivation} \citep[cf.~][]{Ryan2019} \textcolor{black}{and grew from studies of} \emph{intrinsic motivation} \citep[e.g.,][]{Deci1975, Deci1980a}. Intrinsically motivated behaviours are ``behaviours that are motivated by the underlying need for competence and self-determination \ldots. that are performed in the absence of any apparent external contingency'' \citep[p 42]{Deci1980a}.
...
Does a candidate's socioeconomic background influence their progression through the Mountain Leader qualification? How does a \textcolor{black}{candidates'} age influence their progression? Are there any professions that help or hinder candidates' progression?
...
The research presented in this thesis aimed to identify factors that influence the completion rate of the Mountain Leader qualification. Across the project, I employed a multi-source, mixed-method, approach, collecting data \textcolor{black}{from candidates} at various stages in the pathway, and from staff who had an in-depth knowledge of the Mountain Leader process and its candidates. The remainder of this subsection is a summary of the six separate, but related studies in this thesis.
